...
import AIResearchTools3DVisualization from "../content/6I-CYBORG/AIResearchTools3DVisualization";
...
function App() {
  ...
  const tocItems = [
    ...
    { id: "ai-research-tools-3d", title: "AI Research Tools 3D Viz", level: 1 },
